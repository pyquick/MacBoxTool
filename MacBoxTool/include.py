...
from .support.ui.colors import *
from .UIWindow.utils import *
from PySide6.QtCore import QTimer,QObject
from .support.ui.toggle_theme import ThemeManager

from .support.system import subprocess_wrapper
from .support.net.network_handler import *
try:
    from .support.diagnostics.crash_report import *
except Exception:
...
# Apple Silicon / Rosetta detection lives in support.system.rosetta; GUI modules
# import `is_apple_silicon` from there directly.
