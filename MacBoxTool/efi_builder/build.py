...
class BuildOpenCore:
    ...
    def _build_efi(self) -> None:
        ...
        utilities.cls()
        logging.info("Building Configuration {0} model: {1}".format('for external' if self.constants.custom_model else 'on model', self.model))
    ...
    def _generate_base(self) -> None:
        ...
        logging.info("")
        logging.info("- Adding OpenCore v{0} {1}".format(self.constants.opencore_version, 'DEBUG' if self.constants.opencore_debug is True else 'RELEASE'))
    ...
    def _build_opencore(self) -> None:
        ...
        logging.info("")
        logging.info("Your OpenCore EFI for {0} has been built at:".format(self.model))
        logging.info("    {0}".format(self.constants.opencore_release_folder))
        logging.info("")
