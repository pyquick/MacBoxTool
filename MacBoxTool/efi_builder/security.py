    ...
    def _build(self) -> None:
        ...
        if self.constants.sip_status is False or self.constants.custom_sip_value:
            ...
            if self.constants.custom_sip_value:
                logging.info("- Setting SIP value to: {self.constants.custom_sip_value}".format(self=self))
        ...
        if self.constants.disable_cs_lv is True:
            ...
            self.config["NVRAM"]["Add"]["4D1FDA02-38C7-4A6A-9CC6-4BCCA8B30102"]["MBT-Settings"] += " -allow_amfi"
