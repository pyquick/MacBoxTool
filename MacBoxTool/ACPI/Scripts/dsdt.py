import os, errno, tempfile, shutil, sys, binascii, getpass, re
...
class DSDT:
    def __init__(self,constants:Constants,**kwargs):
        self.r  = run.Run()
        self.constants=constants
        self.u  = utils.Utils("SSDT Time")
        self.h = {} # {"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36"}
        self.iasl = self.constants.iasl_stable_path
        self.iasl_legacy = self.constants.iasl_legacy_path
