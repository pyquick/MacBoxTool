...
if sys.platform=="darwin":
    import MacBoxTool.support.system.utilities as utilities
else:
    import MacBoxTool.support.system.utilities_win as utilities
import os
...
from ..system.formatting import format_size
...
class DownloadObject:
    ...
    def get_speed_display(self) -> str:
        ...
        return f"{format_size(int(self.download_speed))}/s"
    ...
    def get_size_display(self) -> str:
        ...
        downloaded = format_size(self.downloaded_size)
