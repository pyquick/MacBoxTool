...
Then when you build MacBoxTool.pkg, the debug version of the helper tool will be used.
...
* Note that ghltbm's Team ID will need to be replaced in main.m with your own Team ID (`S74BDJXQMD` -> `YOUR_TEAM`)
* Additionally you will be required to compile MacBoxTool.app with your own Developer ID Application certificate
