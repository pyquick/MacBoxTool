...
#define MBT_PHT_ERROR_MISSING_ARGUMENTS           160
#define MBT_PHT_ERROR_SET_UID_MISSING             161
#define MBT_PHT_ERROR_SET_UID_FAILED              162
#define MBT_PHT_ERROR_SELF_PATH_MISSING           163
#define MBT_PHT_ERROR_PARENT_PATH_MISSING         164
#define MBT_PHT_ERROR_SIGNING_INFORMATION_MISSING 165
#define MBT_PHT_ERROR_INVALID_TEAM_ID             166
#define MBT_PHT_ERROR_INVALID_CERTIFICATES        167
#define MBT_PHT_ERROR_COMMAND_MISSING             168
#define MBT_PHT_ERROR_COMMAND_FAILED              169
#define MBT_PHT_ERROR_CATCH_ALL                   170
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        if (argc < 2) {
            return MBT_PHT_ERROR_MISSING_ARGUMENTS;
        }
        ...
        if (processPath == nil) {
            return MBT_PHT_ERROR_SELF_PATH_MISSING;
        }

        if (!isSBitSet(processPath)) {
            return MBT_PHT_ERROR_SET_UID_MISSING;
        }

        setuid(0);
        if (getuid() != 0) {
            return MBT_PHT_ERROR_SET_UID_FAILED;
        }

        NSString *parentProcessPath = getParentProcessPath();
        if (parentProcessPath == nil) {
            return MBT_PHT_ERROR_PARENT_PATH_MISSING;
        }
        ...
        if (![[NSFileManager defaultManager] fileExistsAtPath:command]) {
            return MBT_PHT_ERROR_COMMAND_MISSING;
        }
    ...
    return MBT_PHT_ERROR_CATCH_ALL; // Should never reach here
}
